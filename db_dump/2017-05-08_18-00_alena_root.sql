...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 08 2017 г., 18:15
...
(13, 3, 0, '', 'xomobile@|;xomobile@|;', '<p>Дешевые международные звонки</p>@|;<p>Cheap international calls</p>@|;', '@|;@|;', '{"\\u041a\\u0430\\u0440\\u0442\\u0438\\u043d\\u043a\\u0430":"upload\\/articles\\/13\\/img\\/13-590b27e2a9c6b.png@|;upload\\/articles\\/13\\/img\\/13-590b27e2b0117.png@|;"}', '', '[]', '', 0, '0000-00-00 00:00:00', '@|;@|;', '@|;@|;', '@|;@|;', 1, '2017-04-09 20:51:46', '2017-05-04 13:08:50'),
...
(4, 'root', 'alena@xomobile.com', '$2y$10$.L5HG2TCROfeH6bofPyQiu9hS5L3B5trEBp4OM88VNv2twsoB6Jea', 'rR0clMvQsu5h2B4vwPDmJVDcXHit8jeb1MZVsnPIRLHDllRsIkvw3ZXlhmgc', '2017-05-08 15:10:37', '2017-05-08 15:12:38');
