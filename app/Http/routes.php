...
Route::get('adminWoit/login', array('as' => 'login', 'uses' => 'Auth\AuthController@getLogin'));
Route::post('adminWoit/login', array('as' => 'login', 'uses' => 'Auth\AuthController@postLogin'));
Route::get('adminWoit/logout', array('as' => 'logout', 'uses' => 'Auth\AuthController@getLogout'));
...
Route::group(['prefix'=>'adminWoit', 'middleware' => ['auth', 'backend.init']], function(){
